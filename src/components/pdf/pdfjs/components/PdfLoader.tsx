...
// Default worker source - matches the installed pdfjs-dist version.
// Apps can override by passing workerSrc or setting GlobalWorkerOptions.workerSrc.
...
export const PdfLoader = ({
  ...
  useEffect(() => {
    const resolvedWorkerSrc =
      workerSrc || GlobalWorkerOptions.workerSrc || DEFAULT_WORKER_SRC;
